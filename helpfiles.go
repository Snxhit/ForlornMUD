...
var HelpEntries = []HelpEntry{
	...
	},
	{
		id:          6,
		title:       "Profile",
		keywords:    []string{"profile", "profile", "pf", "info"},
	...
	},
	{
		...
		text: []string{
			...
			"and make your character stronger with `train <stat>`!",
			"",
	...
	},
	{
		...
		text: []string{
			...
			"",
			"Try `list <entity>` for a list of items!",
		},
	},
	{
		id:          9,
		...
		text: []string{
			...
			"`attack 2`. This specifies the third entity that you see.",
			"",
	...
	},
	{
		...
		text: []string{
			...
			"",
			"INDEXING: Address entities/items by keyword or number",
			"from the `look` list. `attack dummy` or `attack 0` for",
			"first entity. `take item` or `take 0` for first item.",
			"Indexes start at 0! Read `help indexing` for details.",
			"",
			...
			"<stat>`. View progress with `profile` or `pf`.",
			"",
	...
	},
	{
		id:          16,
		title:       "Pickup",
		keywords:    []string{"pickup", "take", "pick"},
		instruction: []string{"pickup <item>", "take <item>"},
		category:    "Command",
		text: []string{
